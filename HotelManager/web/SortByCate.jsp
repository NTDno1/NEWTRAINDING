                                    ...
                                    <%}%>
                                        ...
                                        <div class="block">
                                            ...
                                            <form action="RoomController" method="get">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>Từ</td><td><input type="number" style="width: 100px;" name="price1" min="0" max="10000" value=""/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Đến</td><td><input type="number"  style="width: 100px;" name="price2" min="0" max="100000" value=""/></td>
                                                    </tr>
                                                    <tr>
